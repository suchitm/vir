...
// mv_lm_uninf_svi
Rcpp::List mv_lm_uninf_svi(Eigen::MatrixXd Y, Eigen::MatrixXd X, int K, int n_iter, bool verbose, double a_tau, double b_tau, int batch_size, double omega, double kappa, double const_rhot);
RcppExport SEXP _vir_mv_lm_uninf_svi(SEXP YSEXP, SEXP XSEXP, SEXP KSEXP, SEXP n_iterSEXP, SEXP verboseSEXP, SEXP a_tauSEXP, SEXP b_tauSEXP, SEXP batch_sizeSEXP, SEXP omegaSEXP, SEXP kappaSEXP, SEXP const_rhotSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type kappa(kappaSEXP);
    Rcpp::traits::input_parameter< double >::type const_rhot(const_rhotSEXP);
    rcpp_result_gen = Rcpp::wrap(mv_lm_uninf_svi(Y, X, K, n_iter, verbose, a_tau, b_tau, batch_size, omega, kappa, const_rhot));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_vir_mv_lm_uninf_svi", (DL_FUNC) &_vir_mv_lm_uninf_svi, 11},
