...
mvlm_uninf_svi_cpp <- function(Y, X, K, n_iter, verbose = TRUE, a_tau = 0.1, b_tau = 0.1, batch_size = 42L, rhot = 0.1) {
    .Call(`_vir_mvlm_uninf_svi_cpp`, Y, X, K, n_iter, verbose, a_tau, b_tau, batch_size, rhot)
}
