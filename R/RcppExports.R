...
#'   (0.5, 1)}
#' @export
mv_lm_uninf_svi <- function(Y, X, K, n_iter, verbose = TRUE, a_tau = 0.1, b_tau = 0.1, batch_size = 10L, omega = 15.0, kappa = 0.6, const_rhot = 0.01) {
    .Call(`_vir_mv_lm_uninf_svi`, Y, X, K, n_iter, verbose, a_tau, b_tau, batch_size, omega, kappa, const_rhot)
}
